    ...
    <SectionWrapper id="sustainability">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14">
        ...
        >
          ...
          <p className="mt-5">A key outcome of the national culminating forum will be the development of a policy brief summarizing the discussions, findings, and recommendations generated throughout the regional workshops.</p>
        </div>
        ...
        >
          ...
          <p className="mt-5">Tertiary audiences include the broader public, reached via social media, press coverage, and online dissemination.</p>
        </div>
