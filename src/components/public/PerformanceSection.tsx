    ...
    <>
      <SectionWrapper id="performance">
        <div className="performance-section">
          ...
          >
            <p>
              Across five regional
              workshops, 150 young
              participants came together
              to explore legal literacy,
              civic responsibility and
              meaningful democratic
              participation — transforming
              regional perspectives into
          ...
          <div className="performance-card-grid">
            {WORKSHOPS.map(
              (workshop, index) => (
                <motion.article
                  key={workshop.id}
                  className={`performance-card performance-card-${workshop.tone}`}
                  initial={{
                    opacity: 0,
                    y: 30,
                  }}
                ...
                >
                  <div className="performance-card-bg" />

                  <div className="performance-card-inner">
                    <div className="performance-card-top">
                      <span className="performance-card-number">
                        {String(
                          workshop.id
                        ).padStart(
                          2,
                    ...
                    <div className="performance-card-place">
                      <span>
                        {
                          workshop.province
                        }
                    ...
                    <div className="performance-card-facilitator">
                      <span>
                        Facilitated by
                      </span>
                    ...
                    <button
                      type="button"
                      className="performance-card-button"
                      onClick={() =>
                        setSelectedWorkshop(
                          workshop
                        )
          ...
          <motion.div
            className="performance-completion"
            initial={{
              opacity: 0,
            }}
            whileInView={{
      ...
      {selectedWorkshop && (
        ...
        >
          <article
            className={`performance-modal performance-modal-${selectedWorkshop.tone}`}
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="performance-modal-side">
              <span className="performance-modal-number">
                {String(
                  selectedWorkshop.id
                ).padStart(
                  2,
              ...
              <div className="performance-modal-city">
                <span>
                  Regional Workshop
                </span>
              ...
              <div className="performance-modal-stats">
                <div>
                  <strong>
                    {
            ...
            <div className="performance-modal-content">
              <div className="performance-modal-heading">
                <span>
                  Facilitated by
                </span>

                <h2 id="performance-modal-title">
                  {
                    selectedWorkshop.city
                  }{' '}
                  Regional Workshop
                ...
                <div className="performance-modal-facilitator">
                  <strong>
                    {
              ...
              <div className="performance-modal-story">
